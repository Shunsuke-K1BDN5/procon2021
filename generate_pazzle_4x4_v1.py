...
class puzzle():
    ...
    def make_pic(self,target,type = "nomal"):
        ...
        Image.fromarray(deffrences.astype(np.uint8)).save(f"E:/procon/data/4x4_v1/eve/2.jpg")
        torch.save(deffrences,"E:/procon/data/4x4_v1/eve/1.pt")
        print("aa")
        print_2d(deffrences)
...
pazzle.create()
print(pazzle.backwerd_rec.keys())
print(pazzle.pazzle)

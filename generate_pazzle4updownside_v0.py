...
class puzzle():
    ...
    def create(self):
        ...
        for i in range(self.s_time):
            ...
            self.pazzle[target[0]][target[1]][2] = 16
    ...
    def move_cell(self,target,i_target):
        ...
        if way == 1 : # 上
            ...
            self.pazzle[target[0]-1][target[1]][2] = 16
            if target[0]-1 < 0:
            ...
            if target[1] + 1 < self.width:
                ...
                self.pazzle[target[0]][target[1]+1][2] = 16
    ...
    def zero2end(self):
        ...
        for i in range(self.hight):
            for j in range(self.width):
                self.place_dimension[i][j] = [0,0,0]
    ...
    def make_pic(self,target,direction,type = "nomal"):
        ...
        Image.fromarray(deffrences.astype(np.uint8)).save(f"E:/procon/data/16x16_LearnDirection_v3/{direction}/{label}.jpg")
        #print(deffrences)
